...
preprocess_test_data <- preprocess_data(test_data, "test", attr(preprocess_train_data, "scaled:center"), attr(preprocess_train_data, "scaled:scale"))
...
for (model_name in model_list) {
  ...
  output_file <- paste("results/", model_name, " prediction.csv", sep = "")
